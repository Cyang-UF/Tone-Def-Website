        ...
        return (
            <div class = "grid-container">
                ...
                <div class = "grid-item LeftSide"> 
                    ...
                    <p id="blocktext"style={{marginBottom: "20px"}}> How to Audition </p>
                    ...
                    time slot!<a id="blocktext-small-blue" href="/Contact">Contact us</a>if you have any further questions! </h2>
